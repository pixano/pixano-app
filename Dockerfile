...
# clean the image
RUN rm -rf $ELISE_BASE/elise/repository.db $ELISE_BASE/Elise_sqlite/ $ELISE_BASE/elise_ext/data/idx/*
RUN rm -rf $ELISE_BASE/elasticlient $ELISE_BASE/fastsearch $ELISE_BASE/juliet
