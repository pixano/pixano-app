...
export class PluginInteractiveSegmentation extends TemplatePluginInstance {
    ...
    get editor() {
      return html`
        <pxn-segmentation-interactive id="main"
                    mode=${this.mode}
                    @create=${this.onCreate}
                    @update=${this.onUpdate}
                    @delete=${this.onDelete}
                    @mode=${this.onModeChange}
                    @selection=${this.onSelection}></pxn-segmentation-interactive>
      `;
    }
}
customElements.define('plugin-interactive-segmentation', PluginInteractiveSegmentation);
